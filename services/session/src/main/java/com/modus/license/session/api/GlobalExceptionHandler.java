...
public class GlobalExceptionHandler {
    ...
    public Mono<ResponseEntity<ErrorResponse>> handleModus(ModusException ex) {
        return Mono.just(ResponseEntity.status(ex.httpStatus()).body(ErrorResponse.of(ex)));
    }
    ...
    /** WebFlux uses WebExchangeBindException instead of MethodArgumentNotValidException. */
    @ExceptionHandler(WebExchangeBindException.class)
    public Mono<ResponseEntity<ErrorResponse>> handleBindValidation(WebExchangeBindException ex) {
